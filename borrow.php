...
$abcd=$row2["uname"];
echo '<div style =  "width:500px; height:100px; background-color:#eeeeee; text-align:center; float: left; margin: 30px 10px 10px 250px;">'."Welcome ".$abcd."<br>"."Thank you for borrowing the book ".'</div>'."<br>";




$sql = "UPDATE book SET status= 'not available' WHERE bid='$usid'";
...
//    echo '<div style =  "width:500px; height:100px; background-color:#eeeeee; text-align:center; float: left; margin: 30px 10px 10px 250px;">'."Record Updated Successfully".'</div>'."<br>";
    ...
    //  echo '<div style =  "width:500px; height:100px; background-color:#eeeeee; text-align:center; float: left; margin: 30px 10px 10px 250px;">'."Error updating record: " . mysqli_error($conn).'</div>'."<br>";
header('Location: error.html');
}

$sql1 = "INSERT INTO borrowbooks (borrowerid, bid) VALUES ('$usidd', '$usid')";
